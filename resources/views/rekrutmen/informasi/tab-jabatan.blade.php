...
>
    <div class="bg-white rounded-xl border shadow-sm border-slate-200">
        ...
        >
            ...
            <p class="text-sm font-normal text-slate-500 mt-2">Daftarkan posisi / divisi serta spesifik jabatannya yang akan dilakukan rekrutmen.</p>
        </div>
            ...
            <div class="flex flex-col gap-6">
                <template x-for="(group, pIdx) in listGroupPosisi" :key="pIdx">
                    ...
                    >
                        ...
                        <div
                            class="w-full md:w-5/12 bg-slate-50 p-5 border-b md:border-b-0 md:border-r border-slate-200 flex flex-col justify-between"
                        >
                            <div>
                                <label
                                    class="block text-sm font-bold text-slate-700 mb-1 tracking-wide"
                                >
                                    Nama Posisi / Divisi<span
                        ...
                        <div class="w-full md:w-7/12 p-5 bg-white">
                            <label
                                class="block text-sm font-bold text-slate-700 mb-1 tracking-wide"
                            >
                                Nama Jabatan<span class="text-red-500 ml-0.5"
                                    >*</span
                                >
                            </label>

                            <div
                                class="flex flex-col border border-slate-300 rounded-md overflow-hidden divide-y-reverse divide-y divide-slate-300 bg-slate-50"
                            >
                                <template
                            ...
                            <div class="mt-5">
                                <button
                                    ...
                                    class="sm:w-auto text-xs font-bold tracking-wide text-blue-700 bg-blue-50 hover:bg-blue-100 px-5 py-3 rounded-md border border-blue-200 transition-colors flex justify-center items-center gap-2 shadow-sm"
                                >

            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        >
                            {{-- Menggunakan variabel $userName yang sudah kita set di atas --}}
                            <div>{{ $userName }}</div>
                    ...
                    <x-slot name="content">
                        {{-- Sembunyikan profile edit jika login sebagai organisasi (opsional) --}}
                        @if (!Auth::guard('organisasi')->check())

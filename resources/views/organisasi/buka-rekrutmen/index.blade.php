        ...
        >
            ...
            <div class="space-y-8">
                ...
                <div class="my-0">
                    ...
                    >
                        Periode Rekrutmen<span class="text-red-500 ml-0.5"
                            >*</span
                        >
                    </label>
                    @php
                    ...
                    <select
                        name="tahun_periode"
                        class="block w-full sm:w-2/3 md:w-1/2 bg-slate-50 border text-slate-600 text-sm font-bold focus:border-blue-600 focus:ring-0 rounded-lg py-3 px-4 transition-colors {{ $errors->has('tahun_periode') ? 'border-red-500 bg-red-50 text-red-700' : 'border-slate-300' }}"
                        required
                    >
                        <option
                            value=""
                ...
                @php
                    ...
                    $panitiaData = [];
                    if (!empty($oldNims)) {
                        foreach ($oldNims as $index => $nim) {
                            $panitiaData[] = [
                                'nim' => $nim,
                                'pesanError' => $errors->first('nim_panitia.' . $index),
                            ];
                        }
                    } else {
        ...
        document.addEventListener(
            ...
            () => {
                window.rekrutmenAlert({
                    icon: 'warning',
                    title: 'Data belum dapat dikirim',
